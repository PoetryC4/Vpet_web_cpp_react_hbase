    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->compareOp = static_cast<TCompareOp::type>(ecast309);
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = static_cast<TThriftServerType::type>(ecast408);
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = static_cast<TThriftServerType::type>(ecast409);
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
