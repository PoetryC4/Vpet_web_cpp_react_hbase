...
class THBaseServiceNull : virtual public THBaseServiceIf {
 public:
  ...
  void listNamespaces(std::vector<std::string> & /* _return */) override {
    return;
  }
  TThriftServerType::type getThriftServerType() override {
    TThriftServerType::type _return = static_cast<TThriftServerType::type>(0);
    return _return;
  }
  void getSlowLogResponses(std::vector<TOnlineLogRecord> & /* _return */, const std::set<TServerName> & /* serverNames */, const TLogQueryFilter& /* logQueryFilter */) override {
    return;
  }
  void clearSlowLogResponses(std::vector<bool> & /* _return */, const std::set<TServerName> & /* serverNames */) override {
    return;
  }
  void getClusterId(std::string& /* _return */) override {
    return;
  }
};
...
class THBaseService_listNamespaces_args {
 public:
  ...
  THBaseService_listNamespaces_args(const THBaseService_listNamespaces_args&) noexcept;
  THBaseService_listNamespaces_args& operator=(const THBaseService_listNamespaces_args&) noexcept;
  THBaseService_listNamespaces_args() noexcept {
  }

  virtual ~THBaseService_listNamespaces_args() noexcept;
...
class THBaseService_listNamespaces_pargs {
 public:
  ...
  virtual ~THBaseService_listNamespaces_pargs() noexcept;
...
class THBaseService_listNamespaces_result {
 public:
  ...
  THBaseService_listNamespaces_result() noexcept {
  }

  virtual ~THBaseService_listNamespaces_result() noexcept;
...
class THBaseService_listNamespaces_presult {
 public:
  ...
  virtual ~THBaseService_listNamespaces_presult() noexcept;
  std::vector<std::string> * success;
  TIOError io;
...
class THBaseService_getThriftServerType_args {
 public:
  ...
  THBaseService_getThriftServerType_args(const THBaseService_getThriftServerType_args&) noexcept;
  THBaseService_getThriftServerType_args& operator=(const THBaseService_getThriftServerType_args&) noexcept;
  THBaseService_getThriftServerType_args() noexcept {
  }

  virtual ~THBaseService_getThriftServerType_args() noexcept;
...
class THBaseService_getThriftServerType_pargs {
 public:
  ...
  virtual ~THBaseService_getThriftServerType_pargs() noexcept;
...
class THBaseService_getThriftServerType_result {
 public:
  ...
  THBaseService_getThriftServerType_result(const THBaseService_getThriftServerType_result&) noexcept;
  THBaseService_getThriftServerType_result& operator=(const THBaseService_getThriftServerType_result&) noexcept;
  THBaseService_getThriftServerType_result() noexcept
                                           : success(static_cast<TThriftServerType::type>(0)) {
  }

  virtual ~THBaseService_getThriftServerType_result() noexcept;
  /**
   * 
...
class THBaseService_getThriftServerType_presult {
 public:
  ...
  virtual ~THBaseService_getThriftServerType_presult() noexcept;
  /**
   * 
   * @see TThriftServerType
   */
...
class THBaseService_getSlowLogResponses_args {
 public:
  ...
  THBaseService_getSlowLogResponses_args() noexcept {
  }

  virtual ~THBaseService_getSlowLogResponses_args() noexcept;
  /**
...
class THBaseService_getSlowLogResponses_pargs {
 public:
  ...
  virtual ~THBaseService_getSlowLogResponses_pargs() noexcept;
  /**
   * @param serverNames Server names to get slowlog responses from
   */
...
class THBaseService_getSlowLogResponses_result {
 public:
  ...
  THBaseService_getSlowLogResponses_result() noexcept {
  }

  virtual ~THBaseService_getSlowLogResponses_result() noexcept;
...
class THBaseService_getSlowLogResponses_presult {
 public:
  ...
  virtual ~THBaseService_getSlowLogResponses_presult() noexcept;
  std::vector<TOnlineLogRecord> * success;
  TIOError io;
...
class THBaseService_clearSlowLogResponses_args {
 public:
  ...
  THBaseService_clearSlowLogResponses_args() noexcept {
  }

  virtual ~THBaseService_clearSlowLogResponses_args() noexcept;
  /**
...
class THBaseService_clearSlowLogResponses_pargs {
 public:
  ...
  virtual ~THBaseService_clearSlowLogResponses_pargs() noexcept;
  /**
   * @param serverNames Set of Server names to clean slowlog responses from
   */
  const std::set<TServerName> * serverNames;
...
class THBaseService_clearSlowLogResponses_result {
 public:
  ...
  THBaseService_clearSlowLogResponses_result() noexcept {
  }

  virtual ~THBaseService_clearSlowLogResponses_result() noexcept;
  std::vector<bool>  success;
  TIOError io;
...
class THBaseService_clearSlowLogResponses_presult {
 public:
  ...
  virtual ~THBaseService_clearSlowLogResponses_presult() noexcept;
  std::vector<bool> * success;
  TIOError io;
...
class THBaseService_getClusterId_args {
 public:
  ...
  THBaseService_getClusterId_args(const THBaseService_getClusterId_args&) noexcept;
  THBaseService_getClusterId_args& operator=(const THBaseService_getClusterId_args&) noexcept;
  THBaseService_getClusterId_args() noexcept {
  }

  virtual ~THBaseService_getClusterId_args() noexcept;
...
class THBaseService_getClusterId_pargs {
 public:
  ...
  virtual ~THBaseService_getClusterId_pargs() noexcept;
...
class THBaseService_getClusterId_result {
 public:
  ...
  THBaseService_getClusterId_result() noexcept
                                    : success() {
  }

  virtual ~THBaseService_getClusterId_result() noexcept;
  std::string success;
...
class THBaseService_getClusterId_presult {
 public:
  ...
  virtual ~THBaseService_getClusterId_presult() noexcept;
  std::string* success;
  ...
  THBaseServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
   ...
   */
  TThriftServerType::type getThriftServerType() override;
  int32_t send_getThriftServerType();
  TThriftServerType::type recv_getThriftServerType(const int32_t seqid);
  /**
   * Retrieves online slow RPC logs from the provided list of
   * RegionServers
   * 
   ...
   */
  void getSlowLogResponses(std::vector<TOnlineLogRecord> & _return, const std::set<TServerName> & serverNames, const TLogQueryFilter& logQueryFilter) override;
  int32_t send_getSlowLogResponses(const std::set<TServerName> & serverNames, const TLogQueryFilter& logQueryFilter);
  void recv_getSlowLogResponses(std::vector<TOnlineLogRecord> & _return, const int32_t seqid);
  /**
   * Clears online slow/large RPC logs from the provided list of
   * RegionServers
   * 
   ...
   */
  void clearSlowLogResponses(std::vector<bool> & _return, const std::set<TServerName> & serverNames) override;
  int32_t send_clearSlowLogResponses(const std::set<TServerName> & serverNames);
  void recv_clearSlowLogResponses(std::vector<bool> & _return, const int32_t seqid);
  /**
   * Returns the cluster ID for this cluster.
   */
  void getClusterId(std::string& _return) override;
  int32_t send_getClusterId();
  void recv_getClusterId(std::string& _return, const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
