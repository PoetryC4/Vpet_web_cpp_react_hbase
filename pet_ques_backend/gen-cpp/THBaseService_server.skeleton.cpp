...
int main(int argc, char **argv) {
  int port = 9090;
  ::std::shared_ptr<THBaseServiceHandler> handler(new THBaseServiceHandler());
  ::std::shared_ptr<TProcessor> processor(new THBaseServiceProcessor(handler));
