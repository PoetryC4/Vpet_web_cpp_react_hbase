...
const std::map<int, const char*> _TLogType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kTLogTypeValues, _kTLogTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const TLogType::type& val) {
  std::map<int, const char*>::const_iterator it = _TLogType_VALUES_TO_NAMES.find(val);
  if (it != _TLogType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const TLogType::type& val) {
  std::map<int, const char*>::const_iterator it = _TLogType_VALUES_TO_NAMES.find(val);
  if (it != _TLogType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _TFilterByOperator_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kTFilterByOperatorValues, _kTFilterByOperatorNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const TFilterByOperator::type& val) {
  std::map<int, const char*>::const_iterator it = _TFilterByOperator_VALUES_TO_NAMES.find(val);
  if (it != _TFilterByOperator_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const TFilterByOperator::type& val) {
  std::map<int, const char*>::const_iterator it = _TFilterByOperator_VALUES_TO_NAMES.find(val);
  if (it != _TFilterByOperator_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
const std::map<int, const char*> _TThriftServerType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(2, _kTThriftServerTypeValues, _kTThriftServerTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));

std::ostream& operator<<(std::ostream& out, const TThriftServerType::type& val) {
  std::map<int, const char*>::const_iterator it = _TThriftServerType_VALUES_TO_NAMES.find(val);
  if (it != _TThriftServerType_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const TThriftServerType::type& val) {
  std::map<int, const char*>::const_iterator it = _TThriftServerType_VALUES_TO_NAMES.find(val);
  if (it != _TThriftServerType_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
...
TLogQueryFilter::~TLogQueryFilter() noexcept {
}
    ...
    switch (fid)
    {
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->logType = static_cast<TLogType::type>(ecast205);
      ...
      case 7:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->filterByOperator = static_cast<TFilterByOperator::type>(ecast206);
...
uint32_t TLogQueryFilter::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.logType) {
    ...
    xfer += oprot->writeI32(static_cast<int32_t>(this->logType));
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.filterByOperator) {
    xfer += oprot->writeFieldBegin("filterByOperator", ::apache::thrift::protocol::T_I32, 7);
    xfer += oprot->writeI32(static_cast<int32_t>(this->filterByOperator));
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
...
void TLogQueryFilter::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TLogQueryFilter(";
  out << "regionName="; (__isset.regionName ? (out << to_string(regionName)) : (out << "<null>"));
  out << ", " << "clientAddress="; (__isset.clientAddress ? (out << to_string(clientAddress)) : (out << "<null>"));
  out << ", " << "tableName="; (__isset.tableName ? (out << to_string(tableName)) : (out << "<null>"));
  out << ", " << "userName="; (__isset.userName ? (out << to_string(userName)) : (out << "<null>"));
  out << ", " << "limit="; (__isset.limit ? (out << to_string(limit)) : (out << "<null>"));
  out << ", " << "logType="; (__isset.logType ? (out << to_string(logType)) : (out << "<null>"));
  out << ", " << "filterByOperator="; (__isset.filterByOperator ? (out << to_string(filterByOperator)) : (out << "<null>"));
  out << ")";
}


TOnlineLogRecord::~TOnlineLogRecord() noexcept {
}
...
void TOnlineLogRecord::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TOnlineLogRecord(";
  out << "startTime=" << to_string(startTime);
  out << ", " << "processingTime=" << to_string(processingTime);
  out << ", " << "queueTime=" << to_string(queueTime);
  out << ", " << "responseSize=" << to_string(responseSize);
  out << ", " << "clientAddress=" << to_string(clientAddress);
  out << ", " << "serverClass=" << to_string(serverClass);
  out << ", " << "methodName=" << to_string(methodName);
  out << ", " << "callDetails=" << to_string(callDetails);
  out << ", " << "param=" << to_string(param);
  out << ", " << "userName=" << to_string(userName);
  out << ", " << "multiGetsCount=" << to_string(multiGetsCount);
  out << ", " << "multiMutationsCount=" << to_string(multiMutationsCount);
  out << ", " << "multiServiceCalls=" << to_string(multiServiceCalls);
  out << ", " << "regionName="; (__isset.regionName ? (out << to_string(regionName)) : (out << "<null>"));
  out << ")";
}
...
void TIOError::printTo(std::ostream& out) const {
  ...
  out << ", " << "canRetry="; (__isset.canRetry ? (out << to_string(canRetry)) : (out << "<null>"));
  out << ")";
}
