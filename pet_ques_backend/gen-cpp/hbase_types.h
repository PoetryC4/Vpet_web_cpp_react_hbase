 ...
 */
class TLogQueryFilter : public virtual ::apache::thrift::TBase {
 public:

  TLogQueryFilter(const TLogQueryFilter&);
  TLogQueryFilter& operator=(const TLogQueryFilter&);
  TLogQueryFilter() noexcept
                  : regionName(),
                    clientAddress(),
                    tableName(),
                    userName(),
                    limit(10),
                    logType(static_cast<TLogType::type>(1)),
                    filterByOperator(static_cast<TFilterByOperator::type>(1)) {
  }

  virtual ~TLogQueryFilter() noexcept;
 ...
 public:
  ...
  TOnlineLogRecord() noexcept
                   : startTime(0),
                     ...
                     userName(),
                     multiGetsCount(0),
                     multiMutationsCount(0),
                     multiServiceCalls(0),
                     regionName() {
  }

  virtual ~TOnlineLogRecord() noexcept;
  int64_t startTime;
