...
const PetDisplay: React.FC = () => {
  ...
  async function defaultAnimation() {
    while (isLaunched.value) {
      for (; durSpeak.value || durSwitch.value || specialInteractionNames.includes(curAnimation.value) || interactionNames.includes(curAnimation.value) || durDebug.value;) {
